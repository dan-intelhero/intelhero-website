...
const PrivacyPage = () => {
  return (
    <div className={styles.main} style={{ padding: '2rem', maxWidth: '800px', margin: 'auto', border: '1px solid #ccc', borderRadius: '8px', backgroundColor: '#fff' }}>
      ...
      <main style={{ padding: '1rem' }}>
        ...
        <p>
          To make a request, contact us at dan@intelhero.com.
        </p>
